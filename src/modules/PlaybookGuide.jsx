...
//
// Content translated from IF master @ 926bac5f for Imaginary AI (SMB) context
// per agent_memory operational_rule 7721c6f4-9754-42b1-8a5a-f29273f9b7a9.
// Rebecca (Imaginary AI, with Imaginary AI methodology) is the editorial voice.
//
...
const PLAYBOOK_DATA = [
  {
    ...
    prompts: [
      ...
      { title: 'Teach me three things you should remember', tag: 'Persistent Memory', text: 'Ask me three questions that would help you understand my business better — the kind of things you\'d want to know if we were working together. Once I answer, save what I tell you as rules so you\'ll remember them in every future conversation.', prompt: 'Ask me three questions that would help you understand my business better — the kind of things you\'d want to know if we were working together. Once I answer, save what I tell you as rules so you\'ll remember them in every future conversation.', tip: 'Seeds the Persistent Memory habit from day one. This is what turns a generic Claude into your Claude.' },
      { title: 'Show me what\'s automated already', tag: 'Automations', text: 'Give me a plain-English list of what\'s already running automatically for my business — what pulls in documents, what watches for things, what posts on my behalf. When each one runs, and what I\'d notice if it stopped working.', prompt: 'Give me a plain-English list of what\'s already running automatically for my business — what pulls in documents, what watches for things, what posts on my behalf. When each one runs, and what I\'d notice if it stopped working.' },
  ...
  },
  {
    ...
    subsections: null,
    prompts: [
      { title: 'Morning briefing', tag: 'Dashboard', text: 'Good morning. Give me a quick rundown of what I need to pay attention to today. Check my calendar, anything new since yesterday, what\'s due this week, and anything else you think I should know about the business right now. Keep it short — just the important stuff.', prompt: 'Good morning. Give me a quick rundown of what I need to pay attention to today. Check my calendar, anything new since yesterday, what\'s due this week, and anything else you think I should know about the business right now. Keep it short — just the important stuff.' },
  ...
  },
  {
    ...
    prompts: [
      ...
      { title: 'Where am I on my annual goals?', tag: 'Financials', text: 'How am I tracking on my annual goals right now? Where do I stand versus where I need to be at this point in the year? What do I need to do between now and the end of the quarter to stay on target? Give me the honest picture.', prompt: 'How am I tracking on my annual goals right now? Where do I stand versus where I need to be at this point in the year? What do I need to do between now and the end of the quarter to stay on target? Give me the honest picture.', tip: 'Run this weekly. Annual goals can sneak up — your assistant tracks progress from your monthly close reports so you don\'t have to.' },
  ...
  },
  {
    ...
    prompts: [
      ...
      { title: 'Compare this year so far to last year', tag: 'Financials', text: 'How is the business doing this year compared to last year at the same point? Revenue, new business, retention, payroll, the big lines. What\'s up, what\'s down, and what\'s that telling us?', prompt: 'How is the business doing this year compared to last year at the same point? Revenue, new business, retention, payroll, the big lines. What\'s up, what\'s down, and what\'s that telling us?' },
  ...
  },
  {
    ...
    subsections: [
      { title: 'Dashboard', prompts: [
        ...
        { title: 'Show me the headline numbers', tag: 'Dashboard', text: 'Give me the headline numbers for the business right now. Month-to-date revenue, year-to-date revenue, progress against my goals, and anything else you\'d put on a one-page summary for me.', prompt: 'Give me the headline numbers for the business right now. Month-to-date revenue, year-to-date revenue, progress against my goals, and anything else you\'d put on a one-page summary for me.' },
      ]},
      ...
      { title: 'Automations', prompts: [
        { title: 'What\'s automated for me?', tag: 'Automations', text: 'What\'s running automatically for my business right now? Give me a list in plain English — what each one does and when it runs. No technical names.', prompt: 'What\'s running automatically for my business right now? Give me a list in plain English — what each one does and when it runs. No technical names.' },
      ...
      { title: 'Settings', prompts: [
        { title: 'Show me my email templates', tag: 'Settings', text: 'Show me the email templates currently set up for my business. What do we use, what does each one say, and when do they fire? I want to know what\'s going out under my name.', prompt: 'Show me the email templates currently set up for my business. What do we use, what does each one say, and when do they fire? I want to know what\'s going out under my name.' },
      ]},
    ],
  },
  {
    ...
    subtitle: 'QuickBooks Online sync, bank & credit card statements, payroll reports, entity-level reports',
    intro: 'Your BCC has automation recipes that quietly pull in your key source data in the background — bank statements from your Gmail, QuickBooks Online activity via the QBO sync, payroll reports as they arrive, and multi-entity roll-ups if you operate more than one entity. In practice, most of the work is already done before you touch it. Use these prompts to confirm things landed cleanly.',
    callouts: null,
    subsections: null,
    prompts: [
      { title: 'Did my QuickBooks sync this month?', tag: 'QBO Sync', text: 'Confirm that my QuickBooks Online data for [month] synced into the BCC cleanly. Give me the top-line numbers — revenue, expenses, net income — and flag anything that looks out of pattern compared to my last few months. If any entity is missing data, tell me before I go looking.', prompt: 'Confirm that my QuickBooks Online data for [month] synced into the BCC cleanly. Give me the top-line numbers — revenue, expenses, net income — and flag anything that looks out of pattern compared to my last few months. If any entity is missing data, tell me before I go looking.' },
      ...
      { title: 'Did all my entities roll up correctly?', tag: 'Multi-Entity', text: 'For businesses running more than one entity: confirm each entity\'s books closed for [month] and the consolidated view rolls up cleanly. Give me a per-entity revenue and net income summary, plus the consolidated total. Flag any entity whose numbers look off or whose sync is behind.', prompt: 'For businesses running more than one entity: confirm each entity\'s books closed for [month] and the consolidated view rolls up cleanly. Give me a per-entity revenue and net income summary, plus the consolidated total. Flag any entity whose numbers look off or whose sync is behind.', tip: 'Skip this prompt if you operate a single entity — the QuickBooks sync prompt above already covers you.' },
      { title: 'The automation didn\'t catch a document — help me file it manually', tag: 'Fallback', text: 'The [document type — e.g. “August bank statement” or “Q3 payroll summary”] didn\'t come through the automation. I\'m attaching it now. Add it to my Documents library, file it correctly, pull out the important numbers, and update anything in the dashboard that should shift because of it. Tell me what changed.', prompt: 'The [document type] didn\'t come through the automation. I\'m attaching it now. Add it to my Documents library, file it correctly, pull out the important numbers, and update anything in the dashboard that should shift because of it. Tell me what changed.', tip: 'Use this when a document arrives by hand-off, a vendor doesn\'t email statements, or the automation misses one. Otherwise, let the automations do their thing.' },
    ],
  },
  {
    id: 's7',
    ...
    prompts: [
      ...
      { title: 'Mark someone as having left', tag: 'People', text: '[Team member\'s name] has left the business, last day [date]. Mark them as inactive — don\'t delete their history. [Any context worth keeping for the record].', prompt: '[Team member\'s name] has left the business, last day [date]. Mark them as inactive — don\'t delete their history. [Any context worth keeping for the record].' },
      ...
      { title: 'Update or add a goal', tag: 'Goals', text: '[Either “Add a new goal” or “Update my goal for”]: [what the goal is — e.g. “$95,000 net income goal for the year” or “30 new signed customer engagements this year”]. Track it against [which metric or data]. [Deadline if it has one].', prompt: '[Either Add a new goal or Update my goal for]: [what the goal is]. Track it against [which metric or data]. [Deadline if it has one].' },
      { title: 'Update my business profile', tag: 'Settings', text: 'Update my business profile: [what\'s changing — business ID, license or registration info, office address, business entity name, tax classification, anything official]. Effective [date].', prompt: 'Update my business profile: [what\'s changing]. Effective [date].' },
    ],
  },
  {
    id: 's8',
  ...
  },
  {
    ...
    subsections: null,
    prompts: [
      { title: 'Teach a hard rule', tag: 'Persistent Memory', text: 'Remember this as a hard rule from now on: [the rule]. Hard rules are things you\'d never want me to bend. Good examples: — “Never send a proposal above $10K without CPA review.” — “Always copy my CPA on financial summaries over $50K.” — “No social media posts ever mention specific premium amounts.”', prompt: 'Remember this as a hard rule from now on: [the rule].' },
  ...
  },
  {
    ...
    callouts: [
      { title: 'Don\'t ask Claude to file taxes or make binding tax positions for you.', body: 'Your CPA or tax preparer is the authoritative source for anything that gets filed with the IRS or your state. Your BCC can pull the numbers, model what-ifs, prep quarterly estimates, and hand your CPA a clean package — but the actual filings and legally-binding positions belong with your professional.' },
      { title: 'Don\'t ask Claude to sign contracts or commit to outside agreements on your behalf.', body: 'Anything that legally binds your business — a customer contract, a vendor commitment, an offer letter — has to go through you with your signature. Your BCC is a great co-drafter and reviewer, but the commit step stays with the owner.' },
      { title: 'Don\'t paste sensitive customer or employee information into the chat.', body: 'Social Security numbers, driver\'s license numbers, credit card numbers, medical information, full bank account numbers — keep those out. Your BCC doesn\'t need them to be helpful, and the chat is not the right place for them.' },
  ...
  {
    id: 's11',
    title: 'Referring another business owner',
    subtitle: 'When a fellow business owner asks what this is',
    intro: 'Once you\'ve been running your BCC for a while, other business owners will ask what it is. Here\'s a prompt that helps you explain it without turning it into a sales pitch — in your own words, in your own voice.',
    callouts: null,
    subsections: null,
    prompts: [
      { title: 'Help me explain my BCC to a fellow business owner', tag: 'Referral', text: 'A fellow business owner asked me what my Business Command Center actually is and what it does for me. Help me explain it in a way that would make sense to them — no sales pitch, no jargon, just the honest version. Focus on what I use it for most, what surprised me about it, and what parts have made the biggest difference in how I run the business. If it fits how I actually feel, work in the honest part most people miss at first: Imaginary AI drove my Claude through the build. My Claude co-built the system and remembers all of it. My Claude is my partner and my network engineer — the system is self-healing and keeps evolving because my Claude has the context to run it with me. Imaginary AI handed us the jumpstart. My Claude runs the day-to-day.', prompt: 'A fellow business owner asked me what my Business Command Center actually is and what it does for me. Help me explain it in a way that would make sense to them — no sales pitch, no jargon, just the honest version. Focus on what I use it for most, what surprised me about it, and what parts have made the biggest difference in how I run the business. If it fits how I actually feel, work in the honest part most people miss at first: Imaginary AI drove my Claude through the build. My Claude co-built the system and remembers all of it. My Claude is my partner and my network engineer — the system is self-healing and keeps evolving because my Claude has the context to run it with me. Imaginary AI handed us the jumpstart. My Claude runs the day-to-day.', tip: 'If your fellow business owner wants to know more after that, send them to imaginaryai.biz — they\'ll take it from there.' },
    ],
  },
  {
    id: 's12',
...
const CALLOUT_STYLES = {
  brand:    { bg: 'var(--ia-cream)',      border: 'var(--ia-teal)',   iconColor: 'var(--ia-teal)',   Icon: Sparkles },
  info:     { bg: 'var(--ia-teal-light)',    border: 'var(--ia-teal)',    iconColor: 'var(--ia-teal)',    Icon: Info },
  warn:     { bg: 'var(--ia-warning-lt)', border: 'var(--ia-warning)', iconColor: 'var(--ia-warning)', Icon: AlertTriangle },
  coaching: { bg: 'var(--ia-cream)',      border: 'var(--ia-navy)',    iconColor: 'var(--ia-navy)',    Icon: Compass },
};
...
function Callout({ variant, title, body }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, fontSize: '14px', lineHeight: 1.6, color: 'var(--ia-ink)' }}>
        <strong style={{ color: 'var(--ia-navy)', marginRight: '4px' }}>{title}</strong>
        <span style={{ color: 'var(--ia-ink)' }}>{body}</span>
      </div>
    </div>
  );
}
...
function PromptCard({ prompt, sectionTitle, subsectionTitle, highlight }) {
  ...
  return (
    <div className="if-card" style={{ marginBottom: '12px', padding: '16px 18px', backgroundColor: 'var(--ia-surface)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', marginBottom: '10px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
        <div style={{ fontWeight: 600, fontSize: '15px', color: 'var(--ia-navy)', lineHeight: 1.35 }}>
          {highlight(prompt.title)}
        </div>
        <span style={{ fontSize: '11px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--ia-teal)', backgroundColor: 'var(--ia-teal-light)', padding: '3px 8px', borderRadius: '10px', whiteSpace: 'nowrap' }}>
          {prompt.tag}
        </span>
      </div>
      <div style={{ fontSize: '14px', lineHeight: 1.6, color: 'var(--ia-ink)', marginBottom: '10px' }}>
        {highlight(prompt.text)}
      </div>
      {prompt.tip && (
        <div style={{ fontSize: '12px', fontStyle: 'italic', color: 'var(--ia-muted)', marginBottom: '10px', borderLeft: '2px solid var(--ia-border)', paddingLeft: '10px' }}>
...
function makeHighlighter(q) {
  ...
  return (text) => {
    ...
    return (
      <>
        {before}
        <mark style={{ backgroundColor: 'var(--ia-warning-lt)', color: 'var(--ia-navy)', padding: '0 2px', borderRadius: '2px' }}>
          {match}
        </mark>
        {after}
      </>
...
function Section({ section, query, forceOpen, highlight }) {
  ...
  return (
    <details open={forceOpen} style={{ marginBottom: '16px', backgroundColor: 'var(--ia-surface)', border: '1px solid var(--ia-border)', borderRadius: '12px', overflow: 'hidden' }}>
      <summary style={{ padding: '18px 20px', cursor: 'pointer', listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '12px', backgroundColor: 'var(--ia-cream)', borderBottom: '1px solid var(--ia-border)' }}>
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 700, fontSize: '17px', color: 'var(--ia-navy)', marginBottom: '4px' }}>
            {highlight(section.title)}
          </div>
          <div style={{ fontSize: '13px', color: 'var(--ia-muted)', lineHeight: 1.5 }}>
            {section.subtitle}
          </div>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
          {!isCalloutOnly && totalCount > 0 && (
            <span style={{ fontSize: '12px', fontWeight: 600, color: 'var(--ia-muted)', backgroundColor: 'var(--ia-page)', padding: '3px 10px', borderRadius: '10px', border: '1px solid var(--ia-border)' }}>
              {totalCount} prompt{totalCount === 1 ? '' : 's'}
            </span>
          )}
          <ChevronDown size={18} color="var(--ia-muted)" style={{ transition: 'transform 200ms' }} className="playbook-chevron" />
        </div>
      </summary>

      <div style={{ padding: '20px' }}>
        {section.intro && (
          <p style={{ fontSize: '14px', color: 'var(--ia-ink)', lineHeight: 1.7, marginTop: 0, marginBottom: '16px' }}>{section.intro}</p>
        )}
        ...
        {isCalloutOnly ? (
          ...
          visibleSubsections.map((sub) => (
            <div key={sub.title} style={{ marginBottom: '20px' }}>
              <h4 style={{ fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--ia-navy)', borderBottom: '2px solid var(--ia-teal-light)', paddingBottom: '6px', marginTop: 0, marginBottom: '12px' }}>
                {highlight(sub.title)}
              </h4>
              {sub.prompts.map((p, i) => (
    ...
    <div style={{ padding: '24px 28px 48px', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ marginBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
          <BookOpen size={22} color="var(--ia-navy)" />
          <h1 style={{ margin: 0, fontSize: '24px', fontWeight: 700, color: 'var(--ia-navy)' }}>
            Playbook &amp; Guide
          </h1>
        </div>
        <p style={{ fontSize: '14px', color: 'var(--ia-muted)', margin: '4px 0 0', lineHeight: 1.6 }}>
      ...
      <div className="if-no-print" style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: 'var(--ia-page)', padding: '12px 0', marginBottom: '12px', borderBottom: '1px solid var(--ia-border)' }}>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{ position: 'relative', flex: 1, minWidth: '240px' }}>
            <Search size={16} color="var(--ia-muted)" style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
            <input
              type="text"
              className="if-input"
              value={query}
        ...
        <div style={{ fontSize: '12px', color: 'var(--ia-muted)', marginTop: '8px', paddingLeft: '2px' }}>
          {query
      ...
      <div style={{ marginTop: '32px', padding: '18px 20px', borderRadius: '10px', backgroundColor: 'var(--ia-cream)', border: '1px solid var(--ia-teal-light)', fontSize: '13px', color: 'var(--ia-ink)', lineHeight: 1.7 }}>
        <strong style={{ color: 'var(--ia-navy)' }}>How to use this Playbook.</strong>{' '}
